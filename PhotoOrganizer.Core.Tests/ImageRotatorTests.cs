...
namespace PhotoOrganizer.Core.Tests
{
    ...
    {
        [Test]
        public void GetRotationParameters_ImageNullOrWhiteSpace_ThrowsArgumentException([Values("", null, " ")]string path)
        {
            // Arrange
        ...
        [Test]
        public void GetRotationParameters_ImageExists_ImageFactoryReturnsImage()
        {
            // Arrange
        ...
        [Test]
        public void GetRotationParameters_OrientationIsTopLeft_ReturnsNull()
        {
            // Arrange
            var imagePath = "c:\\image.jpg";
            var image = Fake.Image();
        ...
        public void GetRotationParameters_ImageMisOriented_ReturnsCorrectEncoderParameters(ImageOrientation orientation, EncoderValue[] expectedValues)
        {
            // Arrange
            var imagePath = "c:\\image.jpg";
            var image = Fake.Image();
